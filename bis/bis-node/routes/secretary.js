...
router.get('/dashboard',                    (req, res) => res.redirect('/secretary/calendar'));
...
router.get('/census',                       ui.secretaryCensus);
router.get('/household/:householdNo',       ui.secretaryHousehold);
...
router.get('/reports',                      ui.secretaryReports);
router.get('/settings',                     ui.secretarySettings);
...
router.post('/reset-password/:userId',      settings.adminResetPassword);
router.post('/deactivate-user/:userId',     settings.deactivateUser);
...
router.get('/create-account',               ui.secretaryCreateAccount);
